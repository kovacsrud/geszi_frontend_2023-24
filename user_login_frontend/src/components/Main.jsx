...
function Main() {
  ...
  <div className="relative z-10 flex flex-col justify-center items-center h-full text-center">
    ...
    <p className="text-lg text-gray-300 mb-8">Felhasználók azonosítása.</p>
    <Link to='/login' className="bg-yellow-400 text-gray-900 hover:bg-yellow-300 py-2 px-6 rounded-full text-lg font-semibold transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg">Belépés</Link>
  </div>
</div>
